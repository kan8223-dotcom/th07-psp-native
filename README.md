...
現在はテスター向けのv0.1.5-betaです。PSP-2000/3000/Goの64MB版と、メモリ使用量を縮小した
...
> v0.1.5候補はPPSSPP上の同一内蔵デモで64MB版と8160フレームまで一致しましたが、
...
`dist/th07-psp-native-v0.1.5-beta-psp1000.zip`と
`dist/th07-psp-native-v0.1.5-beta-psp2000plus.zip`を作ります。原作データ、ユーザーデータ、
