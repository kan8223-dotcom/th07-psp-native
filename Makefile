...
psp3000-a6v4w-me-d1s0-trusted-build:
	...
	$(MAKE) PSP_1000=0 PSP_ME_BULLET_COMPACT_UPDATE=1 \
		PSP_ME_RENDER_UV16=0 PSP_ME_RENDER_XYZ16=0 \
		PSP_ME_RENDER_16BIT_GE_EXPERIMENT=0 PSP_ME_BULLET_OUTPUT_SLIM=0 \
		PSP_ME_BULLET_SEED_SLIM=0 PSP_ME_ITEM_SEED_SLIM=0 \
		PSP_ME_EFFECT_RENDER_STREAM=0 PSP_ME_RENDER_LEAN_CACHE_OWNERSHIP=0 \
		PSP_ME_EDRAM_SEED_BENCH=0 PSP_RID30_AB_ME_UV16=0 \
...
# v0.2.1-beta 配布用: A6v4.1(CP932 wave)構成。SHIKIGAMIはホスト未設定で完全休眠
psp3000-dist-v021-build:
	$(MAKE) PSP_RID30_AB_ME_UV16=0 PSP_RID30_AB_ME_XYZ16=0 \
		...
		PSP_RID30_AB_ME_TITLE_FONT_HOLE_SWAP=1 \
		PSP_RID30_AB_ME_LOCAL_FONT_SUBSET=1 \
		PSP_SHIKIGAMI_HOST_IPV4= PSP_RID30_AB_ME_BUILD_ID=0x26090140u \
