...
# 配布版: 実証済みGEラッパーPRXは本repo直下に同梱（SHA 411e71b3…）。
# 開発機では兄弟repoの原本があればそちらを優先。
ifneq ($(wildcard ../TH07_GE4_ME4_V6_SIMULTANEOUS_CANARY_20260826/deps/ge-wrapper/ge4wrap_texv1.prx),)
...
psp3000-ime7-usage-meter-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083120u PSP_EASY_MIST_AUDIO=0 all
...
psp3000-ime7-usage-meter-no-item-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083121u \
...
psp3000-ime7-usage-meter-mefix-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083122u \
...
psp3000-ime7-edram-seed-bench-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083125u \
...
psp3000-ime7-adaptive-item-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083123u \
...
psp3000-ime7-adaptive-item-prefix-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083124u \
...
psp3000-ime7-item-selftest-diag-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083126u \
...
psp3000-ime7-adaptive-item-cachefix-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083127u \
...
psp3000-ime7-adaptive-item-safe-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083128u \
...
psp3000-ime7-adaptive-item-uncached-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083129u \
...
psp3000-a1-item-motion-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083130u \
...
psp3000-player-shot-perf-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26090131u \
...
psp3000-c1-vertex16-m0-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=$(PSP_C1_BUILD_ID) \
...
psp3000-c2-slim-build:
	...
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=$(PSP_C2_BUILD_ID) \
		PSP_EBOOT_TITLE='$(PSP_C2_BUILD_TITLE)' PSP_EASY_MIST_AUDIO=0 all

# v0.2.0-beta 配布用: RID30構成。SHIKIGAMI観測はホスト未設定で完全休眠(スレッド・通信・IPリテラルなし)
psp3000-dist-v020-build:
	$(MAKE) clean
	rm -f .build-profile-*
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		PSP_PERF_PROFILE=PERF_ACCEPT PSP_PERF_ATTRIB_TARGET=M2 PSP_PERF_GPU_ATTRIB=0 PSP_PERF_PLAYER_SHOT=0 \
		...
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26083130u \
		PSP_EBOOT_TITLE='TH07 PSP v0.2.0-beta' PSP_EASY_MIST_AUDIO=0 all

# v0.2.0-beta NOME配布用: 同構成からME機能を全て外したSC単独版(最大互換/比較用)。MEワーカー・kcall.prx生成なし
psp3000-dist-v020-nome-build:
	$(MAKE) clean
	rm -f .build-profile-*
	$(MAKE) PSP_1000=0 PSP_DIRECT_GAME=0 PSP_DIRECT_MUSIC=0 PSP_PERF_DIAG=1 \
		PSP_PERF_PROFILE=PERF_ACCEPT PSP_PERF_ATTRIB_TARGET=M2 PSP_PERF_GPU_ATTRIB=0 PSP_PERF_PLAYER_SHOT=0 \
		...
		PSP_ENEMY_P5_WARM_QUEUE=0 PSP_BULLET_QUIESCENT_ANM=0 PSP_ASCII_POPUP_BATCH=1 PSP_GUI_TILE_BATCH=0 \
		PSP_FONT_MAIN_RAM=1 PSP_TEXT_BLIT_FAST=1 PSP_TEXT_PREWARM_PROFILE=1 \
		PSP_USAGE_METER=1 PSP_AUDIO4M_BUILD_ID=0x26090120u \
		PSP_EBOOT_TITLE='TH07 PSP v0.2.0-beta NOME' PSP_EASY_MIST_AUDIO=0 all
