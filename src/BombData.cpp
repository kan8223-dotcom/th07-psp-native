...
namespace
{
const char *const g_BombNames[6][2] = {
    {"霊符「夢想封印　散」", "霊符「夢想封印　集」"},
    {"夢符「封魔陣」", "夢符「二重結界」"},
    {"魔符「スターダストレヴァリエ」", "魔符「ミルキーウェイ」"},
    {"恋符「ノンディレクショナルレーザー」", "恋符「マスタースパーク」"},
    {"幻符「インディスクリミネイト」", "幻符「殺人ドール」"},
    {"時符「パーフェクトスクウェア」", "時符「プライベートスクウェア」"},
};
} // namespace

const char *BombData::GetBombName(i32 shotTypeAndCharacter, i32 focused)
{
    if (shotTypeAndCharacter < 0 || shotTypeAndCharacter >= 6 || focused < 0 || focused >= 2)
    {
        return NULL;
    }
    return g_BombNames[shotTypeAndCharacter][focused];
}
...
void BombData::BombReimuACalc(Player *player)
{
    ...
    {
        g_Gui.ShowBombNamePortrait(1185, GetBombName(0, 0));
...
void BombData::BombReimuACalcFocus(Player *player)
{
    ...
    if (bombInfo->bombTimer.HasTicked() && bombInfo->bombTimer == 0)
    {
        g_Gui.ShowBombNamePortrait(1185, GetBombName(0, 1));
...
void BombData::BombReimuBCalc(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1185, GetBombName(1, 0));
...
void BombData::BombReimuBCalcFocus(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1185, GetBombName(1, 1));
...
void BombData::BombMarisaACalc(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1187, GetBombName(2, 0));
...
void BombData::BombMarisaACalcFocus(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1186, GetBombName(2, 1));
...
void BombData::BombMarisaBCalc(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        g_ItemManager.RemoveAllItems();
        player->bombStartPos = player->positionCenter;
        g_Gui.ShowBombNamePortrait(1185, GetBombName(3, 0));
...
void BombData::BombMarisaBCalcFocus(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1186, GetBombName(3, 1));
...
void BombData::BombSakuyaACalc(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1185, GetBombName(4, 0));
...
void BombData::BombSakuyaACalcFocus(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1185, GetBombName(4, 1));
...
void BombData::BombSakuyaBCalc(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1187, GetBombName(5, 0));
        player->bombInfo.bombDuration = 160;
...
void BombData::BombSakuyaBCalcFocus(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1187, GetBombName(5, 1));
        player->bombInfo.bombDuration = 300;
