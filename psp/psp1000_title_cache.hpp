...
// PSP-1000 arena. The title/menu/difficulty lettering atlases keep
// their native 512px width and a 256px height so small text survives the final
// 640x480 -> PSP LCD reduction without exhausting 32 MiB RAM. The cache is
// derived at runtime from the user's own DAT; it is never part of the release
// package.
